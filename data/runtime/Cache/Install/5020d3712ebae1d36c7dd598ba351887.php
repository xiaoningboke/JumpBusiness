...
<link rel="stylesheet" href="/five/public/simpleboot/themes/flat/theme.min.css" />
<link rel="stylesheet" href="/five/public/install/css/install.css" />
<link rel="stylesheet" href="/five/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css" />
...
<body>
	...
	<div class="version"><?php echo (THINKCMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/five/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/five/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
					<button type="submit" class="btn btn-primary">创建数据</button>
				</div>
			</form>
		</section>
		<script src="/five/public/js/jquery.js"></script>
		<script src="/five/public/js/validate.js"></script>
		<script src="/five/public/js/ajaxForm.js"></script>
		<script>
			function TestDbPwd() {
				...
				var url = "/five/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
