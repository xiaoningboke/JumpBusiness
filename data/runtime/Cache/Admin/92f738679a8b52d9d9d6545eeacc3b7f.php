...
<link href="/five/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
<link href="/five/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
<link href="/five/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/five/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/five/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/five/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/five/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
                ...
                <ul class="nav simplewind-nav pull-right">
                    <li class="light-blue">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            ...
                            <?php else: ?>
                                <img class="nav-user-photo" width="30" height="30" src="/five/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
    ...
    <script src="/five/public/js/jquery.js"></script>
    <script src="/five/public/js/wind.js"></script>
    <script src="/five/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
    <script>
    ...
    <script src="/five/public/js/common.js"></script>
    <script src="/five/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>